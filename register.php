 ...
 <option disabled selected>-- Select country --</option> 
     ...
     <?php
       // Using database connection file here
        ...
        $records = mysqli_query($conn, "SELECT distinct country From university");  // Use select query here 
        if ($records) {      
 ...
 <option disabled selected>-- Select courses --</option> 
     ...
     <?php
       // Using database connection file here
        ...
        $records = mysqli_query($conn, "SELECT distinct course-name From Course");  // Use select query here 
        if ($records) {      
while ($row = mysqli_fetch_array($records)){?>
